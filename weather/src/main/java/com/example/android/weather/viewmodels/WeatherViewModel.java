package com.example.android.weather.viewmodels;
...
import com.example.android.weather.data.network.model.response.weather.Main;
...
public class WeatherViewModel extends ViewModel {
    ...
    public java.util.List<List> formatList(java.util.List<List> list) {
        ...
        for(int i = 0 ; i<list.size(); i=i+8){
            com.example.android.weather.data.network.model.response.weather.List list1 = new com.example.android.weather.data.network.model.response.weather.List();
            Main main = new Main();
